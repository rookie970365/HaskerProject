...
urlpatterns = [
    ...
    path("questions/<int:question_id>", views.QuestionDetail.as_view(), name="question_detail"),
    path("vote/question", views.QuestionVote.as_view(), name="vote_question"),
    path("answer/mark/<int:answer_id>", views.AnswerMark.as_view(), name="answer_mark"),
