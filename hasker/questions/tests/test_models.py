...
class TestQuestion(DataSetupMixin, TestCase):
    def test_trending(self):
        users = [
            self.user_model(username="user1", email="user1@mail.xxx"),
            self.user_model(username="user2", email="user2@mail.xxx"),
            self.user_model(username="user3", email="user3@mail.xxx"),
            self.user_model(username="user4", email="user4@mail.xxx"),
        ]
        for user in users:
            user.save()
        questions = [
...
class TestQuestionVote(DataSetupMixin, TestCase):
...
class TestAnswer(DataSetupMixin, TestCase):
    def test_mark(self):
        self.answer_1.mark()
...
class TestAnswerVote(DataSetupMixin, TestCase):
